        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline-block rounded-full bg-brand-100 dark:bg-brand-900/50 px-2 py-0.5 text-xs font-medium text-brand-700 dark:text-brand-300">
                v0.9
              </span>
            </Link>
